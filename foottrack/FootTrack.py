...
def main():
	...
	all_parser_info = {"Tools for footprinting analysis":
						...
						"Miscellaneous tools":
							...
							"SubsampleBam": {"help": "Subsample a .bw-file using samtools", "add_arguments": add_subsample_arguments, "function": "foottrack.tools.subsample_bw.run_subsampling"},
							...
							"FilterFragments": {"help": "Tool for filtering fragments from a .bw-file based on the overlap of reads with .bed-regions", "add_arguments": add_filterfragments_arguments, "function": "foottrack.tools.filter_fragments.run_filterfragments", "space":"\t"}
							}
						}
