...
def main():
	...
	all_parser_info = {"Tools for footprinting analysis":
							...
							"DepthBiascorrect":{"help":"Correct reads with regards to enzyme sequence bias using depth information from TXT files", "add_arguments": add_depth_biascorrect_arguments, "function": "foottrack.tools.depth_biascorrect.run_depth_biascorrect"},
						...
						"Tools for working with motifs/TFBS":
							{
							"TFBScan": {"help":"Identify positions of TFBS given sequence and motifs", "add_arguments": add_tfbscan_arguments, "function": "foottrack.tools.tfbscan.run_tfbscan"},
							"FormatMotifs": {"help": "Utility to deal with motif files", "add_arguments": add_formatmotifs_arguments, "function": "foottrack.tools.format_motifs.run_formatmotifs"},
							"ClusterMotifs": {"help": "Cluster motifs by similarity", "add_arguments": add_motifclust_arguments, "function": "foottrack.tools.motif_clust.run_motifclust", "space":"\t"},
							"ScoreBed": {"help":"Score .bed-file with signal from .bigwig-file(s)", "add_arguments": add_scorebed_arguments, "function": "foottrack.tools.score_bed.run_scorebed"},
							"SubMerge": {"help":"Get all TFBS in a list of regions, merged into one file", "add_arguments": add_subsample_arguments, "function": "foottrack.tools.submerge.run_submerge"}
							},

						"Visualization tools":
							{
							"PlotAggregate": {"help": "Aggregate of .bigwig-signal across TF binding sites", "add_arguments": add_aggregate_arguments, "function": "foottrack.tools.plot_aggregate.run_aggregate", "space":"\t"},
							"PlotHeatmap": {"help": "Heatmap of .bigwig-signal across TF binding sites", "add_arguments": add_heatmap_arguments, "function": "foottrack.tools.plot_heatmap.run_heatmap"},
							"PlotChanges": {"help": "Plot changes in TF binding across multiple conditions (from BINDetect output)", "add_arguments": add_plotchanges_arguments, "function": "foottrack.tools.plot_changes.run_plotchanges"},
							"PlotTracks": {"help": "Plot genomic tracks using the svist4get package", "add_arguments": add_tracks_arguments, "function": "foottrack.tools.plot_tracks.run_tracks"}
							},

						"Miscellaneous tools":
							{
							"DownloadData": {"help": "Download test data for the FootTrack tools", "add_arguments": add_downloaddata_arguments, "function": "foottrack.tools.download_data.run_downloaddata"},
							"MergePDF": {"help": "Merge pdf files to one", "add_arguments": add_mergepdf_arguments, "function":"foottrack.tools.merge_pdfs.run_mergepdf"},
							"MaxPos": {"help": "Get .bed-positions of highest bigwig signal within .bed-regions", "add_arguments": add_maxpos_arguments, "function": "foottrack.tools.maxpos.run_maxpos"},
							"SubsampleBam": {"help": "Subsample a .bam-file using samtools", "add_arguments": add_subsample_arguments, "function": "foottrack.tools.subsample_bam.run_subsampling"},
							"CreateNetwork": {"help": "Create TF-gene network from annotated TFBS", "add_arguments": add_network_arguments, "function": "foottrack.tools.create_network.run_network", "space":"\t"},
							"Log2Table": {"help": "Convert logs from PlotAggregate to tab-delimitered tables of footprint stats", "add_arguments": add_log2table_arguments, "function": "foottrack.tools.log2table.run_log2table"},
							"FilterFragments": {"help": "Tool for filtering fragments from a .bam-file based on the overlap of reads with .bed-regions", "add_arguments": add_filterfragments_arguments, "function": "foottrack.tools.filter_fragments.run_filterfragments", "space":"\t"}
							}
						}
