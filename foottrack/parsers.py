...
def add_biascorrect_arguments(parser):
	...
	optargs.add_argument('--mood', help="Specify background mode: 'global' or 'local' (default: global)", choices=["global", "local"], default="global", type=str)
	...
	optargs.add_argument('--standard', metavar="<float>", help="Standard for background estimation (useful when --mood is 'global') (default: mean of conversion rate)", type=float)
	optargs.add_argument('--window', metavar="<int>", help="Window size for calculating expected signal (useful when --mood is 'local') (default: 100)", type=int, default=100)
