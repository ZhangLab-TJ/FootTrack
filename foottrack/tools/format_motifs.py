...
from foottrack.parsers import add_formatmotifs_arguments
from foottrack.utils.motifs import OneMotif, MotifList
from foottrack.utils.utilities import * #check_required, check_files, expand_dirs
...
def run_formatmotifs(args):
	...
	logger = foottrackLogger("FormatMotifs", args.verbosity)
	logger.begin()
