...
One use-case is to filter out fragments arising from gene-containing plasmids which contaminate cFOOT-seq with reads mapping to exons
"""
...
from foottrack.parsers import add_filterfragments_arguments
from foottrack.utils.regions import RegionList
from foottrack.utils.utilities import *
from foottrack.utils.ngs import index_bam
...
def run_filterfragments(args):
	...
	#Start logger
	logger = foottrackLogger("FilterFragments", args.verbosity)
	logger.begin()
	...
	pg_dict = {"ID":"FilterFragments", "PN":"FootTrack", "CL": logger.cmd, "VN": FootTrack_VERSION}
